...
def trainCoxPASNet(train_x, train_age, train_ytime, train_yevent, eval_x, eval_age, eval_ytime, eval_yevent, In_Nodes,
                   Hidden_Nodes, Out_Nodes, Learning_Rate, L2, Num_Epochs, Dropout_Rate):
